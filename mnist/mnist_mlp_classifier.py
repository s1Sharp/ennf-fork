...
class MnistMLPClassifier(Module):
    ...
    """
    def __init__(self, in_features: int, hidden_layer_sizes: Union[Tuple[int, ...], List[int]], out_features: int):
        """
    ...
    def _build_layers(self) -> None:
        ...
        self._add_layer(self.hidden_layer_sizes[-1], self.out_features, 'none')
        return
    ...
    def _add_layer(self, in_dim: int, out_dim: int, activation_fn: str) -> None:
        ...
        :return: None
        """
        _layer = Linear(in_dim, out_dim, activation_fn)
        self.layers.append(_layer)
        self._parameters.append(_layer.weight)
        self._parameters.append(_layer.bias)
        return
