...
class TestTensorForward(unittest.TestCase):
    ...
    def test_creation_from_iterable(self):
        t = Tensor([1, 2, 3])
        self.assertTrue(t.data.dtype == np.float32)
        assert_almost_equal(t.data, np.array([1, 2, 3]))

    def test_creation_from_ndarray_scalar(self):
        t = Tensor(np.array(1))
        self.assertTrue(t.data.dtype == np.float32)
        assert_almost_equal(t.data, np.array(1))
    ...
    def test_addition_vector(self):
        ...
        c = a + b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([4, 6]))
    ...
    def test_addition_mixed_1(self):
        ...
        c = a + b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([2, 3]))
    ...
    def test_addition_mixed_3(self):
        ...
        c = a + b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, a_np + b_np)
    ...
    def test_negation_vector(self):
        ...
        b = -a
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, -np.array([0, 1]))
    ...
    def test_subtraction_vector(self):
        ...
        c = a - b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([2, 2]))

    def test_subtraction_mixed(self):
        a, b = Tensor(1), Tensor(np.array([1, 2]))
        c = a - b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([0, -1]))
    ...
    def test_multiplication_vector(self):
        ...
        c = a * b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([0, 8]))

    def test_multiplication_mixed_1(self):
        a, b = Tensor(3), Tensor(np.array([1, 2, 3, 4, 5]))
        c = a * b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([3, 6, 9, 12, 15]))
    ...
    def test_inversion_vector(self):
        ...
        b = Tensor(1) / a
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([1, 0.25]))
    ...
    def test_division_vector(self):
        ...
        c = a / b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([3, 2]))

    def test_division_mixed(self):
        a, b = Tensor(1), Tensor(np.array([1, 2]))
        c = a / b
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([1, 0.5]))
    ...
    def test_maximum_vector(self):
        ...
        c = F.maximum(a, b)
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([3, 5]))
    ...
    def test_minimum_vector(self):
        ...
        c = F.minimum(a, b)
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.array([1, 4]))
    ...
    def test_logarithm_vector(self):
        ...
        b = F.log(a)
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.log(np.array([3, 4])))
    ...
    def test_exponent_scalar(self):
        ...
        b = F.exp(a)
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.e)

    def test_exponent_vector(self):
        a = Tensor([5, 0.1])
        b = F.exp(a)
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.exp(np.array([5, 0.1], np.float32)))
    ...
    def test_mat_mul_2(self):
        ...
        c = F.mat_mul(a, b)
        self.assertTrue(c.data.dtype == np.float32)
        assert_almost_equal(c.data, np.matmul(a_np, b_np))
    ...
    def test_reduce_sum_4(self):
        ...
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.sum(a_np, (0, -1)))

    def test_reduce_mean_1(self):
        a = Tensor([1, 2, 3])
        b = F.reduce(a, reduction='mean')
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, (1+2+3)/3)

    def test_reduce_mean_2(self):
        a = Tensor([[1, 2, 3], [3, 4, 5]])
        b = F.reduce(a, reduction='mean')
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, (1+2+3 + 3+4+5) / (2 * 3))

    def test_reduce_mean_3(self):
        a = Tensor([[1.5, 2, 3], [3.5, 4, 5]])
        b = F.reduce(a, axis=0, reduction='mean')
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([(1.5+3.5)/2, (2+4)/2, (3+5)/2]))
    ...
    def test_reduce_mean_4(self):
        ...
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.mean(a_np, (0, -1)))
    ...
    def test_slice_1(self):
        ...
        b = a[:2]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([1, 2]))

    def test_slice_2(self):
        a = Tensor([1, 2, 3])
        b = a[1:2]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([2]))

    def test_slice_3(self):
        a = Tensor([1, 2, 3])
        b = a[:]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([1, 2, 3]))
    ...
    def test_slice_6(self):
        ...
        b = a[:, 0]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([1, 4]))

    def test_slice_7(self):
        a = Tensor([[1, 2, 3], [4, 5, 6]])
        b = a[:, :2]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([[1, 2], [4, 5]]))

    def test_slice_8(self):
        a = Tensor([[1, 2, 3], [4, 5, 6]])
        b = a[1, :]
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([4, 5, 6]))
    ...
    def test_relu_vector(self):
        ...
        b = F.relu(a)
        self.assertTrue(b.data.dtype == np.float32)
        assert_almost_equal(b.data, np.array([3, 0, 0]))
    ...
    def test_nested_ops_1(self):
        ...
        assert_almost_equal(result, result_tensor.data)
